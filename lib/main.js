...
var flashToggleButton = require("toolbarbutton").ToolbarButton({
    ...
    onCommand: function () {
        flashToggle(); // this toggles the flash status
        
        // The following should not be necessary, but sometimes the AddonManager
        // events don't get called, for example:
        // 1) open firefox and a site of your choice
        // 2) show source of this page
        // 3) close firefox
        // 4) reopen firefox -> events aren't recieved (probably because exports.main is not called and thus the event handler doesn't get registered)
