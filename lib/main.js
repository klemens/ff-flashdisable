...
var useClickToPlay = simplePrefs.prefs.useClickToPlay;
...
var listeners = {
    ...
    onPrefUseClickToPlay:
        function(name) {
            useClickToPlay = simplePrefs.prefs.useClickToPlay;
        }
}
...
exports.main = function(options, callback) {
    ...
    clickCallback = currentState => {
        if("disabled" == currentState) {
            if(useClickToPlay) {
                flash.setState(PluginStateManager.CLICK_TO_PLAY);
            } else {
    ...
    simplePrefs.on("useClickToPlay", listeners.onPrefUseClickToPlay);
};
...
exports.onUnload = function(reason) {
    ...
    simplePrefs.removeListener("useClickToPlay", listeners.onPrefUseClickToPlay);
}
