...
var flashName = require("simple-prefs").prefs.flashName;
...
function flashToggle() {
    AddonManager.getAddonsByTypes(["plugin"], function(addons) {
        ...
        notifications.notify({
            title: "FlashDisable",
            text: "Seems like you haven't installed Flash.",
...
exports.main = function(options, callback) {
    ...
    // this does not work with addon kit 1.8, options.loadReason is always undefined
